...
router.group(() => {
  ...
  router.group(() => {
    ...
    router.get('/:postId/comments/pending', [PostsController, 'pendingComments']).use(middleware.auth())
  }).prefix('/posts')
  ...
  router.group(() => {
    ...
    router.patch('/:commentId/approval', [CommentsController, 'updateApproval']).use(middleware.auth())
  }).prefix('/comments')
